...
<aside id="sidebar"
    class="fixed flex flex-col mt-0 top-0 px-5 left-0 h-screen z-99999 transition-all duration-300 ease-in-out border-r border-gray-200 dark:border-gray-800 bg-gradient-to-b from-[#FF3BB7] from-30% to-[#870C5E] to-100% dark:from-[#962C6F] dark:to-[#461436] text-white"
    x-data="{
        openSubmenus: {},
        init() {
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden" src="/images/logo/logo-dark.svg" alt="Logo" width="181" height="37" />
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block" src="/images/logo/logo-dark.svg" alt="Logo" width="181"
                height="37" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="/images/logo/logo-icon.svg" alt="Logo" width="40" height="40" />
        ...
        <nav class="mb-6">
            <div class="flex flex-col gap-4">
                @foreach ($menuGroups as $groupIndex => $menuGroup)
                    <div>
                        <!-- Menu Group Title -->
                        <h2 class="mb-4 text-xs uppercase flex leading-[20px] text-white"
                            :class="(!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen) ?
                                    ...
                                    @else
                                        ...
                                        <a href="{{ $item['path'] }}" class="menu-item group"
                                            ...
                                            <span
                                                ...
                                                @if (!empty($item['new']))
                                                    <span
                                                        class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold bg-purple-600 text-white">
                                                        new
                                                    </span>
                                                @endif
                                            </span>
