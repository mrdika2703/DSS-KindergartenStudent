            ...
            <div @click.outside="$wire.set('isModalSiswa', false)"
                ...
                <form wire:submit.prevent="simpanSiswa">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            <label class="block mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">Semester</label>
                            <div class="relative z-20 bg-transparent" x-data="{ isOptionSelected: false }">
                            ...
                            @error('semester') <span class="text-xs text-red-500 mt-1 block">{{ $message
                                }}</span> @enderror
                        </div>
                    </div>
