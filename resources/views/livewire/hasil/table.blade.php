<div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="relative">
        ...
        <!-- Efek Loading -->
        <div wire:loading wire:target="searchSiswa, filterKelas, filterTahunAjaran, filterSemester, gotoPage, previousPage, nextPage">
            <div
                            ...
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="text-sm font-semibold text-gray-800 dark:text-white/90 dark:text-gray-400">
                                    <span class="text-xs font-normal block text-gray-500 dark:text-white/90">{{
                                        $hasil->siswa->nis }} 
                                        <span class="pl-2 text-gray-400">{{ $hasil->siswa->kelas }} / {{ $hasil->siswa->semester }}</span>
                                        </span>
