...
<div
    ...
    <div class="flex items-end space-x-4">
        <div class="w-1/4">
            <label for="filterKelas" class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-400">Pilih
                Kelas</label>
        ...
        <div class="w-1/4">
            <label for="filterTahunAjaran" class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-400">Pilih
                Tahun</label>
            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
