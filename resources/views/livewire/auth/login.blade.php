<div>
    ...
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                    ...
                    <div>
                        ...
                        <div>
                            <form wire:submit.prevent="authenticate">
                                @error('email')
                                <div class="px-4 py-2.5 mb-4 text-sm shadow-theme-xs bg-red-100 dark:bg-red-200/80 text-red-700/100 dark:text-red-800 border border-red-400 w-full rounded-lg">
                                    {{ $message }}
                                </div>
                                @enderror
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" wire:model="email" placeholder="email@gmail.com"
                                        ...
                                        @error('email') <span class="text-xs text-red-500 mt-1 block">{{ $message
                                            }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input :type="showPassword ? 'text' : 'password'" id="password"
                                                wire:model="password" wire:key="input-password"
                                            ...
                                            @error('password') <span class="text-xs text-red-500 mt-1 block">{{ $message
                                                }}</span> @enderror
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div x-data="{ checkboxToggle: false }">
                                            <label for="checkboxToggle"
                                                ...
                                                <div class="relative">
                                                    <input type="checkbox" id="checkboxToggle" class="sr-only"
                                        ...
                                        <a href="/"
                                            class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm pointer-events-none cursor-not-allowed">
                                            Lupa password?
                                        </a>
                                    </div>
                                    <!-- Button -->
                                    <div>
                                        <button type="submit" wire:loading.attr="disabled"
                                            class="bg-pink-500 shadow-theme-xs hover:bg-pink-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition">
            ...
            <div class="bg-gradient-to-b from-[#FF3BB7] from-30% to-[#870C5E] to-100% dark:from-[#962C6F] dark:to-[#461436] relative hidden h-full w-full items-center lg:grid lg:w-1/2">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-white dark:text-white/60">
                            Sistem Pendukung Keputusan Pemilihan Siswa Sangat Terampil menggunakan AHP & Fuzzy Tsukamoto
                        </p>
                    </div>
                </div>
            </div>
